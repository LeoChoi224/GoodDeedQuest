...
import CoachScreen from './src/coach/CoachScreen';
import AdminScreen from './src/admin/AdminScreen';
import AuthScreen from './src/auth/AuthScreen';

type ScreenName = 'Auth' | 'Recommend' | 'Verify' | 'Challenge' | 'Shorts' | 'Map' | 'Growth' | 'Shop' | 'Coach' | 'Admin';

export default function App() {
  const [currentScreen, setCurrentScreen] = useState<ScreenName>('Recommend');
